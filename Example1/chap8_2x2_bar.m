%Virtual control functin alpha1 and adaptive law theta1
...
sys=0.5*r1/(a1^2)*S1^6*(norm(fai1,2))^2-eta1*x-c1/r1*x^3;%theta1
...
x2_bar=-S1^3*x2_bar1^2/sqrt(S1^6*x2_bar1^2+eps1^2); %altha1
sys(1)=x2_bar;   %x2_bar
